...
<head>
	<title>发表博客</title>
	<link rel="stylesheet" type="text/css" href="/Blog/static/plugins/bootstrap/css/bootstrap.min.css">
	<script type="text/javascript" src="/Blog/static/js/jquery.min.js"></script>
	<script type="text/javascript" src="/Blog/static/plugins/bootstrap/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/Blog/static/js/UI.js"></script>
	<script type="text/javascript" src="/Blog/static/plugins/wangEditor/release/wangEditor.min.js"></script>
	<style type="text/css">
...
<body>
	<div class="form">
		...
		<button class="btn btn-primary" style="float: right;" onclick="save()">保存</button>
	</div>
</body>
</html>
